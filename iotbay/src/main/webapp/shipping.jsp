...
%>
<head>
    <title>IoTBay - Shipping Management</title>
        ...
        <navbar>
            ...
            <% } else { %>
                <div class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" role="button">My Account</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="ShippingServlet" method="post" style="display: inline;">
                                        ...
                                        <button type="submit" class="btn-red" onclick="return confirm('Are you sure?')">Delete</button>
                                    </form>
                                </td>
                            </tr>
                        <% } %>
