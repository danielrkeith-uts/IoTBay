...
-- Payment
INSERT INTO Payment(PaymentId, UserId, CardId, Amount, PaymentStatus)
VALUES
    (1, 1, 1, 23.45, 1),
    (2, 2, 2, 45.67, 0),
    (3, 3, 3, 89.99, 0),
...
VALUES(1, 'John Smith', '123456789', '2026-08', '123', 1),
    (2, 'Jane Doe', '987654321', '2027-01', '456', 2),
    (3, 'Alice Johnson', '112233445', '2026-06', '789', 3),
    (4, 'Bob Williams', '556677889', '2025-12', '234', 4),
    (5, 'Charlie Brown', '334455667', '2028-03', '567', 5),
    (6, 'Emily Davis', '998877665', '2029-11', '890', 6),
    (7, 'Frank Miller', '223344556', '2025-09', '345', 7),
    (8, 'Grace Lee', '667788990', '2027-07', '678', 8),
    (9, 'Henry Clark', '445566778', '2026-05', '901', 9),
    (10, 'Ivy Martinez', '778899001', '2028-10', '123', 10),
    (11, 'Jack Wilson', '990011223', '2029-04', '456', 11),
    (12, 'Karen Thompson', '556677889', '2027-02', '789', 12),
    (13, 'Liam White', '334455667', '2026-08', '234', 13),
    (14, 'Mia Harris', '998877665', '2025-11', '567', 14),
    (15, 'Noah Green', '223344556', '2028-09', '890', 15),
    (16, 'Olivia Baker', '667788990', '2029-06', '345', 16),
    (17, 'Peter Hall', '445566778', '2027-12', '678', 17),
    (18, 'Quinn Scott', '778899001', '2026-03', '901', 18),
    (19, 'Ryan Adams', '990011223', '2028-07', '123', 19),
    (20, 'Sophia Mitchell', '112233445', '2029-01', '456', 20);
